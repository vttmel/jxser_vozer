...
local _GetFruit = function(nItemIndex)
	ConsumeEquiproomItem(1,6,1,4897,-1)
	if random(1,100) <= 70 then
		AddItem(6,1,4898,1,0,0,0)
...
function main(nItemIdx)
	...
	if CalcEquiproomItemCount(6,1,4897,-1) < 1 then
	...
	if P == 4896 then  
		ChangeOwnFeature( 1, 63*18, 307,  0, 0, 0, 0)
