...
function common_talk()
	...
	elseif (GetSeries() == 3) and (GetFaction() == "gaibang") then
		...
		elseif (UTask_gb == 80*256) then						-- ÖØ·µºóµÄ×ÔÓÉ³öÈë
			Say("KhiÕu hãa tö ta ®©y chİ t¹i bèn ph­¬ng ng­¬i ®õng suèt ngµy ngåi kh«ng ra ®Êy!",3,"D¹! §Ö tö muèn ra giang hå rÌn luyÖn thªm!/goff_yes","§Ö tö tù thÊy m×nh vâ nghÖ cßn kĞm, ch­a thÓ xuÊt s­!/no")
