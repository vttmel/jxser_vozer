...
if (tl_gettaskcourse() == 2) then
	...
	if (tl_gettaskcourse() == 3) then
		...
		Say("<color=green>D· TÈu:<color><enter>VŞ "..GetPlayerSex().." nµy ®· hoµn thµnh tÊt c¶ ®­îc <color=yellow>"..myCountTimes.."<color> nhiÖm vô, nhiÖm vô ngµy h«m nay cßn l¹i lµ <color=yellow>"..(40 - GetTask(ID_TASKLINK_LIMITNUM)).."<color> nhiÖm vô ch­a lµm, ng­¬i cã muèn lµm n÷a kh«ng?",2,"§­¬ng nhiªn, mau cho ta biÕt nhiÖm vô tiÕp theo lµ g×/Task_TaskProcess","§Ó ta nghØ ng¬i mét l¸t ®·! Ta bËn råi/Task_Wait");
