...
function BattleClass:CancelWaiting(szName, nCamp)
...
function BattleClass:LeaveMap(szName)
	...
	if nPlayerIndex > 0 then
		CallPlayerFunction(nPlayerIndex, NewWorld, unpack(self.pManager.tbSignUpPos))
	end
end
...
function BattleClass:OnClose()
	...
	self.pManager:DelBattle(self.nId)
end
